...
const MenuOne: React.FC<Props> = ({ props }) => {
    ...
    return (
        <>
            <div className={`header-menu style-one ${fixedHeader ? 'fixed' : 'absolute'} top-0 left-0 right-0 w-full md:h-[74px] h-[56px] bg-[#fdfcf9] ${props}`}>
                        ...
                        <div className="menu-main h-full max-lg:hidden">
                                <ul className='flex items-center gap-8 h-full'>
                                    ...
                                    <li className="h-full relative">
                                        ...
                                        <div className="sub-menu py-3 px-5 -left-0 absolute bg-white rounded-b-xl">
                                            <ul className="w-full">
                                                <li>
                                                    <Link
                                                        href="/pages/about"
                                   ...
                                   {/* <li className='h-full'>
                                    ...
                                    <li className="h-full relative group">
                                        <Link
                                            href="/shop/breadcrumb1"
                                            className={`text-button-uppercase duration-300 h-full flex items-center justify-center ${pathname.includes('/shop/breadcrumb1') ? 'active' : ''}`}
                                        >
                                            ÜRÜNLERİMİZ
                                        </Link>

                                        <div className="absolute left-0 top-full bg-white shadow-xl rounded-b-xl hidden group-hover:block z-50 px-8 py-6 w-[700px]">
                                            <div className="grid grid-cols-4 gap-10">

                                                {/* HAVLU */}
                                                <div>
                                                    <Link href="/shop/breadcrumb1?type=havlu" className="font-semibold text-black hover:underline block mb-1">HAVLU</Link>
                                                    <ul className="space-y-1">
                                                        <li><Link href="/shop/breadcrumb1?type=Banyo Havlusu" className="text-secondary hover:underline">Banyo Havlusu</Link></li>
                                                        <li><Link href="/shop/breadcrumb1?type=50x90 Havlu" className="text-secondary hover:underline">50×90 Havlu</Link></li>
                                                        <li><Link href="/shop/breadcrumb1?type=Mutfak Havlusu" className="text-secondary hover:underline">Mutfak Havlusu</Link></li>
                                                    </ul>
                                                </div>

                                                {/* BORNOZ */}
                                                <div>
                                                    <Link href="/shop/breadcrumb1?type=bornoz" className="font-semibold text-black hover:underline block mb-1">BORNOZ</Link>
                                                    <ul className="space-y-1">
                                                        <li><Link href="/shop/breadcrumb1?type=Tek Kişilik Bornoz" className="text-secondary hover:underline">Tek Kişilik</Link></li>
                                                        <li><Link href="/shop/breadcrumb1?type=Aile Bornoz Seti" className="text-secondary hover:underline">Aile Seti</Link></li>
                                                    </ul>
                                                </div>

                                                {/* NEVRESİM TAKIMI */}
                                                <div>
                                                    <Link href="/shop/breadcrumb1?type=Nevresim Takımı" className="font-semibold text-black hover:underline block mb-1">NEVRESİM TAKIMI</Link>
                                                    <ul className="space-y-1">
                                                        <li><Link href="/shop/breadcrumb1?type=Tek Kişilik Nevresim Takımı" className="text-secondary hover:underline">Tek Kişilik</Link></li>
                                                        <li><Link href="/shop/breadcrumb1?type=Çift Kişilik Nevresim Takımı" className="text-secondary hover:underline">Çift Kişilik</Link></li>
                                                    </ul>
                                                </div>

                                                {/* ALEZ */}
                                                <div>
                                                    <Link href="/shop/breadcrumb1?type=alez" className="font-semibold text-black hover:underline block">ALEZ</Link>
                                                    <Link href="/shop/breadcrumb1?type=yorgan" className="font-semibold text-black hover:underline block">YORGAN</Link>
                                                    <Link href="/shop/breadcrumb1?type=paspas" className="font-semibold text-black hover:underline block">PASPAS</Link>
                                                    <Link href="/shop/breadcrumb1?type=peştemal" className="font-semibold text-black hover:underline block">PEŞTEMAL</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <div className="container h-full">
                        <div className="menu-main h-full overflow-hidden">
                            <div className="heading py-2 relative flex items-center justify-center">
                                ...
                                <Link href={'/'} className='logo text-3xl font-semibold text-center'>PAMUKİZİ</Link>
                            </div>
                            ...
                            <div className="list-nav mt-6">
                                <ul>
                                    ...
                                    >
                                        <a href={'/'} className={`text-xl font-semibold flex items-center justify-between`}>ANASAYFA
            ...
            <Icon.CaretRight size={20} />
                                        ...
                                        <div className="sub-nav-mobile">
                                            ...
                                            <div className="list-nav-item w-full pt-3 pb-12">
                                                <div className="nav-link grid grid-cols-1 gap-4">
                                                    <Link
                                                        href="/pages/about"
                                                        className={`nav-item text-base font-medium text-secondary ${pathname === '/pages/about' ? 'active' : ''}`}
                                                    >
                                                        Hakkımızda
                                                    </Link>
                                                </div>
                                   ...
                                   {/* <li
                                    ...
                                    <li className={`${openSubNavMobile === 6 ? 'open' : ''}`} onClick={() => handleOpenSubNavMobile(6)}>
                                        <a href="/shop/breadcrumb1" className="text-xl font-semibold flex items-center justify-between mt-5">
                                            ÜRÜNLERİMİZ
                                            <span className="text-right">
            <Icon.CaretRight size={20} />
        </span>
                                        ...
                                        <div className="sub-nav-mobile">
                                            ...
                                            <div className="list-nav-item w-full pt-3 pb-12">
                                                <div className="nav-link flex flex-col gap-6">
                                                    {/* HAVLU */}
                                                    <div>
                                                        <Link href="/shop/breadcrumb1?type=havlu" className="nav-item font-semibold mb-2 block">HAVLU</Link>
                                                        <ul className="flex flex-col gap-2 pl-4">
                                                            <li><Link href="/shop/breadcrumb1?type=Banyo Havlusu" className="text-secondary">Banyo Havlusu</Link></li>
                                                            <li><Link href="/shop/breadcrumb1?type=50x90 Havlu" className="text-secondary">50×90 Havlu</Link></li>
                                                            <li><Link href="/shop/breadcrumb1?type=Mutfak Havlusu" className="text-secondary">Mutfak Havlusu</Link></li>
                                                        </ul>
                                                    </div>

                                                    {/* BORNOZ */}
                                                    <div>
                                                        <Link href="/shop/breadcrumb1?type=bornoz" className="nav-item font-semibold mb-2 block">BORNOZ</Link>
                                                        <ul className="flex flex-col gap-2 pl-4">
                                                            <li><Link href="/shop/breadcrumb1?type=Tek Kişilik Bornoz" className="text-secondary">Tek Kişilik</Link></li>
                                                            <li><Link href="/shop/breadcrumb1?type=Aile Bornoz Seti" className="text-secondary">Aile Seti</Link></li>
                                                        </ul>
                                                    </div>

                                                    {/* NEVRESİM TAKIMI */}
                                                    <div>
                                                        <Link href="/shop/breadcrumb1?type=Nevresim Takımı" className="nav-item font-semibold mb-2 block">NEVRESİM TAKIMI</Link>
                                                        <ul className="flex flex-col gap-2 pl-4">
                                                            <li><Link href="/shop/breadcrumb1?type=Tek Kişilik Nevresim Takımı" className="text-secondary">Tek Kişilik</Link></li>
                                                            <li><Link href="/shop/breadcrumb1?type=Çift Kişilik Nevresim Takımı" className="text-secondary">Çift Kişilik</Link></li>
                                                        </ul>
                                                    </div>

                                                    {/* DİĞERLERİ */}
                                                    <div className="flex flex-col gap-2">
                                                        <Link href="/shop/breadcrumb1?type=alez" className="nav-item font-semibold">ALEZ</Link>
                                                        <Link href="/shop/breadcrumb1?type=yorgan" className="nav-item font-semibold">YORGAN</Link>
                                                        <Link href="/shop/breadcrumb1?type=paspas" className="nav-item font-semibold">PASPAS</Link>
                                                        <Link href="/shop/breadcrumb1?type=pestemal" className="nav-item font-semibold">PEŞTEMAL</Link>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li
                                        ...
                                        onClick={() => handleOpenSubNavMobile(3)}
                                    >
                                        <a href={'/pages/contact'} className='text-xl font-semibold flex items-center justify-between mt-5'>İLETİŞİM
                                            <span className='text-right'>
                                                <Icon.CaretRight size={20} />
                                            </span>
                                        </a>
