...
const WhatNewOne: React.FC<Props> = ({ data, start, limit }) => {
    const [activeTab, setActiveTab] = useState<string>('havlu');
            ...
            <div className="whate-new-block md:pt-20 pt-10">
                <div className="container">
                    ...
                    {/*    <div className="heading3">What{String.raw`'s`} new</div>*/}
                        <div className="heading3">Seç & İncele</div>
                        <div className="menu-tab flex items-center gap-2 p-1 bg-surface rounded-2xl mt-6">
                            {['havlu', 'bornoz', 'Nevresim Takımı', 'yorgan', 'peştemal', 'alez', 'paspas'].map((type) => (
                                <div
                                    key={type}
