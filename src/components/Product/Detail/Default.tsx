                    ...
                    <div className="container flex justify-between gap-y-6 flex-wrap">
                        ...
                        <div className="product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
                            ...
                            <div className="get-it mt-6 pb-8 border-b border-line">
                                <div className="heading5">Bugün Alın</div>
                                <div className="item flex items-center gap-3 mt-4">
                                    <div className="icon-delivery-truck text-4xl"></div>
                                    <div>
                                        <div className="text-title">Hızlı Gönderim</div>
                                        <div className="caption1 text-secondary mt-1"> En Kısa Sürede Ulaşım</div>
                                    </div>
                                </div>
                                <div className="item flex items-center gap-3 mt-4">
                                    <div className="icon-phone-call text-4xl"></div>
                                    <div>
                                        <div className="text-title">Her Gün Destek</div>
                                        <div className="caption1 text-secondary mt-1">Her gün 8:30 AM to 10:00 arası destek</div>
                                    </div>
                                </div>
                                <div className="item flex items-center gap-3 mt-4">
                                    <div className="icon-return text-4xl"></div>
                                    <div>
                                        <div className="text-title">14 Gün İçinde İade</div>
                                        <div className="caption1 text-secondary mt-1">14 Gün İçinde İade Edebilirsiniz.</div>
                                    </div>
                                </div>
                            </div>
                            <div className="list-product hide-product-sold  menu-main mt-6">
                                <div className="heading5 pb-4">Bunları Da Seveceksiniz</div>
                                <Swiper
                                    spaceBetween={12}
                                    slidesPerView={2}
                                    scrollbar={{
                        ...
                        <div className="desc-block mt-8">
                            <div className={`desc-item description ${activeTab === 'description' ? 'open' : ''}`}>
                                <div className='grid md:grid-cols-2 gap-8 gap-y-5'>
                                    <div className="left">
                                        <div className="heading6">Tanım</div>
                                    ...
                                    <div className="right">
                                        <div className="heading6">Bu Ürün Hakkında</div>
                                ...
                                <div className="grid lg:grid-cols-4 grid-cols-2 gap-[30px] md:mt-10 mt-6">
                                    <div className="item">
                                        <div className="icon-delivery-truck text-4xl"></div>
                                        <div className="heading6 mt-4">Hızlı Gönderim</div>
                                    ...
                                    <div className="item">
                                        ...
                                        <div className="heading6 mt-4">Pamuklu Malzeme</div>
                                        <div className="text-secondary mt-2">Use on walls, furniture, doors and many more surfaces. The possibilities are endless.</div>
                                    </div>
                                    <div className="item">
                                        <div className="icon-guarantee text-4xl"></div>
                                        <div className="heading6 mt-4">Yüksek Kalite</div>
                                        <div className="text-secondary mt-2">Use on walls, furniture, doors and many more surfaces. The possibilities are endless.</div>
                                    </div>
                                    <div className="item">
                                        <div className="icon-leaves-compatible text-4xl"></div>
                                        <div className="heading6 mt-4">Son Derece Uyumluluk</div>
                                        <div className="text-secondary mt-2">Use on walls, furniture, doors and many more surfaces. The possibilities are endless.</div>
                                    </div>
                                </div>
                            </div>
                            <div className={`desc-item specifications flex items-center justify-center ${activeTab === 'specifications' ? 'open' : ''}`}>
                                <div className='lg:w-1/2 sm:w-3/4 w-full'>
                                    <div className="item bg-surface flex items-center gap-8 py-3 px-10">
                                        <div className="text-title sm:w-1/4 w-1/3">Derecelendirme</div>
                                        <div className="flex items-center gap-1">
                                    ...
                                    <div className="item flex items-center gap-8 py-3 px-10">
                                        <div className="text-title sm:w-1/4 w-1/3">Kumaş</div>
                                        <p>100% polyester</p>
                                    </div>
                                    {/*<div className="item bg-surface flex items-center gap-8 py-3 px-10">
                                    ...
                                    <div className="item flex items-center gap-8 py-3 px-10">
                                        <div className="text-title sm:w-1/4 w-1/3">Beden</div>
                                        <p>S, M, L, XL</p>
                                    </div>
                                    <div className="item bg-surface flex items-center gap-8 py-3 px-10">
                                        <div className="text-title sm:w-1/4 w-1/3">Renkler</div>
                                        <p> Gri, Kırmızı, Mavi, Siyah</p>
                                    </div>
                                    <div className="item flex items-center gap-8 py-3 px-10">
                                        <div className="text-title sm:w-1/4 w-1/3">Bakım</div>
