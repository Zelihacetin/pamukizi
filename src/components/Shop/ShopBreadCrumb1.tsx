...
const ShopBreadCrumb1: React.FC<Props> = ({ data, productPerPage, dataType, gender, category }) => {
    ...
    const [type, setType] = useState<string | null | undefined>(dataType || 'havlu');
    ...
    const toggleType = (item: string) => {
        setExpandedType(prev => prev === item ? null : item)
        setType(prev => prev === item ? null : item)
        setCurrentPage(0)
    }
    ...
    const handleType = (item: string | null) => {
        setType(prev => prev === item ? null : item); // filtreleme
        setExpandedType(prev => prev === item ? null : item); // alt kategori açma/kapama
        setCurrentPage(0); // sayfa sıfırlama (varsa)
    };
                    ...
                    <div className="container lg:pt-[134px] pt-24 pb-10 relative">
                        <div className="main-content w-full h-full flex flex-col items-center justify-center relative z-[1]">
                            ...
                            <div className="list-tab flex flex-wrap items-center justify-center gap-y-5 gap-8 lg:mt-[70px] mt-12 overflow-hidden">
                                {['bornoz', 'Nevresim Takımı', 'havlu', 'alez', 'peştemal', 'yorgan', 'paspas'].map((item, index) => (
                                    <div
                                        key={index}
                    ...
                    <div className="flex max-md:flex-wrap max-md:flex-col-reverse gap-y-8">
                        <div className="sidebar lg:w-1/4 md:w-1/3 w-full md:pr-12">
                            <div className="filter-type pb-8 border-b border-line">
                                <div className="heading6">Ürün Çeşitleri</div>
                                <div className="list-type mt-4">
                                    {['bornoz', 'Nevresim Takımı', 'havlu', 'alez', 'peştemal', 'yorgan', 'paspas'].map((item, index) => {
                                        const hasSubTypes = data.some(p => p.type === item && p.subType);
                                        const subTypes = [...new Set(data.filter(p => p.type === item && p.subType).map(p => p.subType))];
                                        const isExpanded = expandedType === item;

                                        return (
                                            <div
                                                key={index}
                                                className="mb-2"
                                                onMouseEnter={() => setExpandedType(item)}
                                            ...
                                            >
                                                ...
                                                >
                                                    <div className='text-secondary font-semibold has-line-before hover:text-black capitalize'>
                                                        {item}
                                                    </div>
                                                ...
                                                {/* Alt Kategoriler */}
                                                {hasSubTypes && subTypes.length > 0 && expandedType === item && (
                                                    <div className="pl-4 mt-1 space-y-1">
                                                        {subTypes.map((sub, idx) => (
                                                            <div
                                                                key={idx}
                                                                className='caption1 cursor-pointer text-secondary hover:text-black'
                                                                onClick={() => handleType(sub || null)}
                                                            >
                                                                - {sub}
                                                            </div>
                                                        ))}
                            ...
                            <div className="filter-color pb-8 border-b border-line mt-8">
                                <div className="heading6">RENKLER</div>
                                <div className="list-color flex items-center flex-wrap gap-3 gap-y-4 mt-4">
                                    ...
                                    >
                                        ...
                                        <div className="caption1 capitalize">pembe</div>
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        <div className="caption1 capitalize">kırmızı</div>
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        <div className="caption1 capitalize">yeşil</div>
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        <div className="caption1 capitalize">sarı</div>
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        <div className="caption1 capitalize">mor</div>
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        <div className="caption1 capitalize">siyah</div>
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        <div className="caption1 capitalize">beyaz</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="filter-heading flex items-center justify-between gap-5 flex-wrap">
                                ...
                                <div className="right flex items-center gap-3">
                                    <div className="select-block relative">
                                        ...
                                        >
                                            <option value="Sorting" disabled>Sırala</option>
                                            <option value="soldQuantityHighToLow">Çok Satanlar</option>
                                    ...
                                    (selectedType || selectedSize || selectedColor || selectedBrand) && (
                                        <>
                                            ...
                                            >
                                                ...
                                                <span className='text-button-uppercase text-red'>TEMİZLE</span>
                                            </div>
                                        </>
                                    )
                                }
