                    ...
                    <div className="container lg:pt-[134px] pt-24 pb-10 relative">
                        <div className="main-content w-full h-full flex flex-col items-center justify-center relative z-[1]">
                            <div className="text-content">
                                <div className="heading2 text-center">{dataType === null ? 'Ürünler' : dataType}</div>
            ...
            <div className="shop-product breadcrumb1 lg:py-20 md:py-14 py-10">
                <div className="container">
                    <div className="list-product-block relative">
                            ...
                            <div className="right flex items-center gap-3">
                                ...
                                <div className="select-block relative">
                                    ...
                                    >
                                        ...
                                        <option value="soldQuantityHighToLow">En Çok Satanlar</option>
                        ...
                        <div
                            className={`sidebar style-dropdown bg-white grid md:grid-cols-3 grid-cols-2 md:gap-[30px] gap-6 ${openSidebar ? 'open' : ''}`}
                        >
