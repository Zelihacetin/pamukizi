                                ...
                                <div className="container w-full h-full flex items-center relative">
                                    <div className="text-content basis-1/2">
                                      {/*  <div className="text-sub-display">Sale! Up To 50% Off!</div>*/}
                                        <div className="text-display md:mt-5 mt-2">Yumuşaklığın ve Konforun Adı</div>
                                        <Link href='/shop/breadcrumb1' className="button-main md:mt-8 mt-3">İncele</Link>
                                    </div>
                        ...
                        <SwiperSlide>
                            <div className="slider-item h-full w-full relative">
                                <div className="container w-full h-full flex items-center relative">
                                    <div className="text-content basis-1/2">
                                       {/* <div className="text-sub-display">Sale! Up To 50% Off!</div>*/}
                                        <div className="text-display md:mt-5 mt-2">Her Dokunuşta Doğallık</div>
                                        <Link href='/shop/breadcrumb-img' className="button-main md:mt-8 mt-3">İncele</Link>
                                    </div>
                                    <div className="sub-img absolute w-1/2 2xl:-right-[60px] -right-[0] sm:-bottom-[60px] bottom-0">
                                        <Image
                                            src={'/images/slider/bg2.webp'}
                                            width={670}
                                            height={936}
                                            alt='bg1-2'
                                            priority={true}
